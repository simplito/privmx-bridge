...
export class SrpLogic {
    ...
    static getConfig(): SrpConfig {
        const N = Hex.toBN(<types.core.Hex>"");
        const g = Hex.toBN(<types.core.Hex>"02");
        const k = SrpLogic.get_k(N, g);
        const conf: SrpConfig = {N, g, k};
        return conf;
    }
