...
export const API_ERROR_CODES = {
    ...
    "CONTAINER_ROTATED_ALREADY"            : {code: 0x600F, message: "Container keys were already rotated by a concurrent request"},
    ...
    "NO_SUBSCRIPTIONS_TO_MODIFY"            : {code: 0x6203, message: "Failed to modify subscriptions - there is no active subscriber session available"},
    "MEDIA_SERVER_SOCKET_ALREADY_CLOSED"    : {code: 0x6204, message: "Media server socket is already closed"},
    "CANNOT_CONNECT_TO_MEDIA_SERVER"        : {code: 0x6205, message: "Cannot connect to media server"},
    "ERROR_DURING_REQUEST_TO_MEDIA_SERVER"  : {code: 0x6206, message: "Error during sending request to media server"},
    "MAIN_MEDIA_SESSION_FOR_USER_MISSING"   : {code: 0x6207, message: "There is no main session with Janus created for user"},
    "STREAM_ROOM_CLOSED"                    : {code: 0x6208, message: "Stream room is closed and no new stream can be published or joined"},
    "MEDIA_ROOM_ALREADY_EXISTS"             : {code: 0x6209, message: "A room with this ID already exists on the media server"},
    "MEDIA_ROOM_NOT_FOUND"                  : {code: 0x620A, message: "The requested room does not exist on the media server"},
    "MEDIA_ROOM_FULL"                       : {code: 0x620B, message: "The media room has reached its maximum capacity"},
    "MEDIA_USER_NOT_FOUND"                  : {code: 0x620C, message: "The specified user or feed was not found in the room"},
    "MEDIA_USER_NOT_JOINED"                 : {code: 0x620D, message: "User is not a participant in this room"},
    "MEDIA_UNAUTHORIZED"                    : {code: 0x620E, message: "Action refused: invalid secret or unauthorized request"},
    "MEDIA_ALREADY_PUBLISHING"              : {code: 0x620F, message: "User is already publishing a stream in this room"},
    "MEDIA_SERVER_ERROR"                    : {code: 0x6210, message: "Media server error"},
    "MEDIA_INVALID_SDP"                     : {code: 0x6211, message: "The media server rejected the provided SDP negotiation"},
    "MEDIA_PLUGIN_NOT_FOUND"                : {code: 0x6212, message: "The requested media plugin is not available"},
    "UNKNOWN_MEDIA_SERVER_EXCEPTION"        : {code: 0x6213, message: "Unknown media server exception"},
    "MEDIA_USER_ALREADY_JOINED"             : {code: 0x6214, message: "User has already joined the media room"},
    "MEDIA_FEED_NOT_FOUND"                  : {code: 0x6215, message: "The specified media feed does not exist"},
    ...
    "GROUP_META_UNREACHABLE"                : {code: 0x6223, message: "Group metadata entry would become unreadable; rewrite the affected metadata plane first"},
