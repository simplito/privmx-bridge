...
export class StreamApiValidator extends BaseValidator {
    ...
    constructor(
        ...
        this.registerMethod("streamRoomListParticipants", this.builder.createObject({
            streamRoomId: this.tv.streamRoomId,
        }));
        ...
        this.registerMethod("streamTrickle", this.builder.createObject({
            ...
            rtcCandidate: this.builder.createObject({
                ...
                component: this.builder.createOneOf([this.builder.nullValue, this.builder.createEnum(["rtcp", "rtp"])]),
                foundation: this.tv.stringOrNull,
                port: this.tv.numberOrNull,
                priority: this.tv.numberOrNull,
                protocol: this.builder.createOneOf([this.builder.nullValue, this.builder.createEnum(["tcp", "udp"])]),
                ...
                tcpType: this.builder.createOneOf([this.builder.nullValue, this.builder.createEnum(["active", "passive", "so"])]),
                type: this.builder.createOneOf([this.builder.nullValue, this.builder.createEnum(["host", "prflx", "relay", "srflx"])]),
