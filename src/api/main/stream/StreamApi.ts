...
export class StreamApi extends BaseApi implements streamApi.IStreamApi {
    ...
    async streamRoomCreate(model: streamApi.StreamRoomCreateModel): Promise<streamApi.StreamRoomCreateResult> {
        ...
        const streamRoom = await this.streamService.createStreamRoom(cloudUser, model.contextId, model.resourceId || null, model.type, model.users, model.managers, model.data, model.keyId, model.keys, model.policy || {}, model.groups || [], model.groupManagers || [], model.groupKeys || []);
    ...
    async streamRoomUpdate(model: streamApi.StreamRoomUpdateModel): Promise<types.core.OK> {
        const cloudUser = this.sessionService.validateContextSessionAndGetCloudUser();
        const streamRoom = await this.streamService.updateStreamRoom(cloudUser, model.id, model.users, model.managers, model.data, model.keyId, model.keys, model.version, model.force, model.policy, model.resourceId || null, model.groups || [], model.groupManagers || [], model.groupKeys || []);
        this.requestLogger.setContextId(streamRoom.contextId);
        return "OK";
    }
